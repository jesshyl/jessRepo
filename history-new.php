...
<body>
<nav class="breadcrumb" style="padding: 0px 20px"><i class="Hui-iconfont">&#xe67f;</i> 首页<span class="c-gray en">&gt;</span> 数据报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<table class="table" style="height:100%">
	<tr>
		<!--<td width="100%" class="va-t"><ul id="treeDemo" class="ztree"></ul></td>-->
		<td width="100%" class="va-t" height="120px" style="border: 0px">
		<div class="container">
		            <div class="row">
		                <div col-sm-12">
	...
	<tr>
		<td class="va-t" style="border:0px;width: 100%;margin:0px;padding:0px"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height=400px src="history-figure-new.php"></iframe></td>
	</tr>
</table>
<!--_footer 作为公共模版分离出去-->
...
$(function(){
	$(".button28").click(function(){
		...
		Iframe.attr("src","history-figure-new.php?sensor_num="+encodeURIComponent(ssn));
	});
