...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页<span class="c-gray en">&gt;</span> 数据报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<table class="table" style="height:100%">
	<tr>
		<td width="180px" class="va-t"><ul id="treeDemo" class="ztree"></ul></td>
		<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height=1000px src="history-figure.php"></iframe></td>
	</tr>
</table>
<!--_footer 作为公共模版分离出去-->
...
$(function(){
	...
	var zNode6 = [{ id:16, pId:1, name:"差异沉降"}];
