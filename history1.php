...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报表 <span class="c-gray en">&gt;</span> 数据报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<table class="table" style="height:100%">
	<tr>
		<td width="180px" class="va-t"><ul id="treeDemo" class="ztree"></ul></td>
		<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height=700px src="history-figure.php"></iframe></td>
	</tr>
</table>
<!--_footer 作为公共模版分离出去-->
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
			...
			if (treeNode.isParent) {
				...
				if(treeNode.name.indexOf('JK')<0){
					demoIframe.attr("src","history-figure.php?sensor_num="+encodeURIComponent(treeNode.name));
				}
				return true;
			}
		}
...
$(function(){
	...
	var zNode1 = [{ id:11, pId:1, name:"管片钢筋应变监测项"}];
	var zNode11 = [{ id:111, pId:11, name:"JK1"}];
	var zNode12 = [{ id:112, pId:11, name:"JK2"}];
	var zNode13 = [{ id:113, pId:11, name:"JK3"}];
	var zNode14 = [{ id:114, pId:11, name:"JK4"}];
	var zNode15 = [{ id:115, pId:11, name:"JK5"}];
	var zNode16 = [{ id:116, pId:11, name:"JK6"}];
	var zNode2 = [{ id:12, pId:1, name:"管片混凝土应变监测项"}];
	var zNode21 = [{ id:121, pId:12, name:"JK1"}];
	var zNode22 = [{ id:122, pId:12, name:"JK2"}];
	var zNode23 = [{ id:123, pId:12, name:"JK3"}];
	var zNode24 = [{ id:124, pId:12, name:"JK4"}];
	var zNode25 = [{ id:125, pId:12, name:"JK5"}];
	var zNode26 = [{ id:126, pId:12, name:"JK6"}];
	var zNode3 = [{ id:13, pId:1, name:"管片温度监测项"}];
	var zNode31 = [{ id:131, pId:13, name:"JK1"}];
	var zNode32 = [{ id:132, pId:13, name:"JK2"}];
	var zNode33 = [{ id:133, pId:13, name:"JK3"}];
	var zNode34 = [{ id:134, pId:13, name:"JK4"}];
	var zNode35 = [{ id:135, pId:13, name:"JK5"}];
	var zNode36 = [{ id:136, pId:13, name:"JK6"}];
	var zNode4 = [{ id:14, pId:1, name:"管片接缝位移监测项"}];
	var zNode41 = [{ id:141, pId:14, name:"JK1"}];
	var zNode42 = [{ id:142, pId:14, name:"JK2"}];
	var zNode43 = [{ id:143, pId:14, name:"JK3"}];
	var zNode44 = [{ id:144, pId:14, name:"JK4"}];
	var zNode45 = [{ id:145, pId:14, name:"JK5"}];
	var zNode46 = [{ id:146, pId:14, name:"JK6"}];
	var zNode5 = [{ id:15, pId:1, name:"管片螺栓应变监测项"}];
	var zNode51 = [{ id:151, pId:15, name:"JK1"}];
	var zNode52 = [{ id:152, pId:15, name:"JK2"}];
	var zNode53 = [{ id:153, pId:15, name:"JK3"}];
	var zNode54 = [{ id:154, pId:15, name:"JK4"}];
	var zNode55 = [{ id:155, pId:15, name:"JK5"}];
	var zNode56 = [{ id:156, pId:15, name:"JK6"}];
	var zNodes;
//添加第一个监测项的分支
